...
public class ERobotDrive implements MotorSafety {
	...
	private Motor m_centerLeftMotor;
	private Motor m_frontRightMotor;
	private Motor m_rearLeftMotor;
	private Motor m_centerRightMotor;
	 ...
	 */
	public ERobotDrive(Motor frontLeftMotor,
			Motor rearLeftMotor, Motor centerLeftMotor,
			Motor centerRightMotor, Motor frontRightMotor,
	 ...
	 * 
	 * @param leftFrontDrive
	 * @param leftRearDrive
	 * @param rightFrontDrive
	 * @param rightRearDrive
	 */
	public ERobotDrive(Motor leftFrontDrive,
			Motor leftRearDrive, Motor rightFrontDrive,
			Motor rightRearDrive) {
		initRobotDrive();
		m_frontLeftMotor = leftFrontDrive;
		m_rearLeftMotor = leftRearDrive;
		m_frontRightMotor = rightFrontDrive;
		m_rearRightMotor = rightRearDrive;
	...
	public void setLeftRightMotorOutputs(double leftOutput, double rightOutput) {
		...
		if (m_frontLeftMotor != null) {
			m_frontLeftMotor.set(limit(leftOutput) * m_invertedMotors[MOTOR_FRONT_LEFT] * m_maxOutput);
		}
		if (m_centerLeftMotor != null) {
			m_centerLeftMotor.set(limit(leftOutput) * m_invertedMotors[MOTOR_CENTER_LEFT] * m_maxOutput);
		}
		m_rearLeftMotor.set(limit(leftOutput) * m_invertedMotors[MOTOR_REAR_LEFT] * m_maxOutput);

		if (m_frontRightMotor != null) {
			m_frontRightMotor.set(-limit(rightOutput) * m_invertedMotors[MOTOR_FRONT_RIGHT] * m_maxOutput);
		}
		if (m_centerRightMotor != null) {
			m_centerRightMotor.set(-limit(rightOutput) * m_invertedMotors[MOTOR_CENTER_RIGHT] * m_maxOutput);
		}
		m_rearRightMotor.set(-limit(rightOutput)* m_invertedMotors[MOTOR_REAR_RIGHT] * m_maxOutput);
